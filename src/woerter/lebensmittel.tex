...
\Subtitle{Fleisch, Fisch und Wildbret}

\begin{longtable}{lll}
\TSubst{n}{Fleisch}{---}{мясо} \\
\TASubst{(leicht) angegangenes Fleisch}{слегка порченое мясо, мясо с душком} \\
\TASubst{gesalzenes Fleisch}{солонина} \\
\TASubst{schieres Fleisch}{мякоть} \\
\TASubst{Frischfleisch}{сырое мясо} \\
\TASubst{gehacktes Fleisch, Hackfleisch}{рублено мясо} \\
...
\TASubst{bedingttaugliches Fleisch}{условно годное мясо} \\
