...
\TSubst{f}{So\ss e}{-n}{соус, подливка} \\
\TSubst{m}{Ketchup}{-s}{кетчуп} \\
\TSubst{f}{Mayonnaise}{-n}{майонез} \\
\TSubst{f}{Butter}{---}{сливочное масло} \\
\TSubst{n}{\"Ol}{-e}{растительное масло} \\
\TASubst{Sonnenblumen\"ol}{подсолнечное масло} \\
\TASubst{Oliven\"ol}{оливковое масло} \\
\TASubst{Lein\"ol}{льняное масло} \\
\TASubst{Mandel\"ol}{миндальное масло} \\
\TASubst{Erdnu\ss\"ol}{арахисовое масло}
\end{longtable}
